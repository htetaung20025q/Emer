  ...
  return (
    <>
      ...
      <button 
        ...
        className="fixed bottom-8 right-8 md:bottom-12 md:right-12 z-40 flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-full shadow-[0_10px_40px_rgba(220,38,38,0.4)] hover:shadow-[0_10px_50px_rgba(220,38,38,0.6)] transform hover:scale-105 transition-all duration-300"
      >
        <svg className="w-5 h-5 md:w-6 md:h-6 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
          <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
        </svg>
        <span className="hidden md:block text-lg">Support KHUNYIKALSAL</span>
        <span className="md:hidden text-base">Support Us</span>
      </button>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm font-sans">
            ...
            >
              ...
              <div className="text-center mb-8 mt-2">
                ...
                <h3 className="text-2xl font-black text-slate-900 mb-2 tracking-tight">Support Our Mission</h3>
                <p className="text-slate-500 text-sm md:text-base leading-relaxed px-4">
                  Thank you for considering a donation! Your support helps us keep the servers running and provide free emergency guidelines to everyone.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-[#1f4287] p-5 rounded-2xl shadow-md border border-[#16336e] relative overflow-hidden text-white group transition-transform hover:-translate-y-1 duration-300">
                  ...
                  <div className="text-sm text-blue-100 mb-4 font-medium relative z-10">U Maung Maung</div>
                ...
                <div className="bg-gradient-to-r from-[#fcb813] to-[#f9a304] p-5 rounded-2xl shadow-md border border-[#e5a50e] relative overflow-hidden text-[#4a3605] group transition-transform hover:-translate-y-1 duration-300">
                  ...
                  <div className="text-sm font-semibold opacity-90 mb-4 relative z-10">Daw Su Su</div>
